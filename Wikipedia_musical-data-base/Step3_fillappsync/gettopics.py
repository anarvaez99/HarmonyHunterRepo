...
movie_topics = ['Love', 'Friendship', 'Royal', 'Justice', 'Identity', 'Family', 'Adventure', 'Growth', 'Hope', 'History', 'Fantasy', 'Humor', 'Tragedy',
  'Nature', 'Mythology', 'Diversity', 'Education', 'War', 'Art', 'Travel', 'Politics', 'Magic', 'School', 'Teenager',
  'Fashion', 'Crime', 'Survival', 'Dream', 'Fairytale', 'Time', 'Leadership', 'Celebration', 
  'Loneliness', 'Change', 'Faith', 'Forgiveness', 'Discovery', 'Power', 'Pop', 'Rock', 'Rap', 'Classical', 'Dating', 
  'Summer', 'Winter', 'Spring', 'Disco', 'Book', 'Revolution', 'Freedom', 'Legacy', 'Courage','Sacrifice', 'Revenge', 
  'Survival', 'Isolation', 'Pride', 'Reunion', 'Horror', 'God', 'Heaven', 'Hell', 'Home']
