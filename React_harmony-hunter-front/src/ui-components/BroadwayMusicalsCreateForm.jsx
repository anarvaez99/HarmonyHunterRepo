...
import { createBroadwayMusicals } from "../graphql/mutations";
const client = generateClient();
export default function BroadwayMusicalsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setMusicalName(initialValues.MusicalName);
    setReleaseYear(initialValues.ReleaseYear);
    setProductionType(initialValues.ProductionType);
    setMusicAuthor(initialValues.MusicAuthor);
    setWikiLink(initialValues.WikiLink);
    setPosterLink(initialValues.PosterLink);
    setSpotifyLink(initialValues.SpotifyLink);
    setTrackList(initialValues.TrackList);
    setMusicDuration(initialValues.MusicDuration);
    setMusicalSummary(initialValues.MusicalSummary);
    setMusicalTopics(initialValues.MusicalTopics);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createBroadwayMusicals.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "BroadwayMusicalsCreateForm")}
      {...rest}
    >
      <TextField
        label="Musical name"
